...
public class XLSReaderTest extends BaseTest
{
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE1, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLEMath, "xls"), XLSOptions.Default.withRowLabels(false)); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLELogical, "xls"), XLSOptions.Default.withRowLabels(false)); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE1XLS, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE2, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE2XLS, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE3, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE3XLS, "xls"), XLSOptions.Default); 
        assertNotNull(r);
    ...
    {
        XlsReader r = new XlsReader(qualifiedFileName(SAMPLE3EmptyRows, "xls"), 
    ...
    @Test
    public final void testReadIQDataSheet() throws IOException 
    {
        XlsReader r = new XlsReader(qualifiedFileName("IQData.xlsx", "xls"), XLSOptions.Default.withRowLabels(false)); 
        assertNotNull(r);
        ...
        mr.calculateAdjustedRSquared();
        mr.calculateTotalSumOfSquares();
        mr.calculateRSquared();
        mr.estimateRegressionParameters();
        mr.estimateRegressionParametersStandardErrors();
        mr.estimateErrorVariance();
        mr.estimateRegressionStandardError();
        mr.estimateResiduals();
        mr.calculateHat();
