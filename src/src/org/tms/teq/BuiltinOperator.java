...
public enum BuiltinOperator implements Labeled, Operator
{
    ...
    Sum2Oper(TokenType.StatOp, 5),
    MeanOper(TokenType.StatOp, 5),
    MedianOper(TokenType.StatOp, 5),
    StDevOper(TokenType.StatOp, 5),
    StDevSampleOper(TokenType.StatOp, 5),
    VarOper(TokenType.StatOp, 5),
    VarSampleOper(TokenType.StatOp, 5),
    MinOper(TokenType.StatOp, 5),
    MaxOper(TokenType.StatOp, 5),
    RangeOper(TokenType.StatOp, 5),
    KurtOper(TokenType.StatOp, 5),
    SkewOper(TokenType.StatOp, 5),
    CountOper(TokenType.StatOp, 5),
